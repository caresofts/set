 ...
 */
define(['require','modules/settings_service','modules/settings_panel','modules/apn/apn_settings_manager','shared/toaster','modules/dialog_service'],function(require) {
  'use strict';
