define(['require','panels/call/call_constant','panels/call/call_forwarding','panels/call/call_utils','modules/dialog_service','modules/settings_panel'],function(require) {
  'use strict';
