define(['require','modules/settings_panel','modules/addon_manager','panels/addon_details/addon_details','modules/settings_service','shared/toaster'],function(require) {
  'use strict';
