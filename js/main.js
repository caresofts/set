...
require(['config/require'], function() {
  ...
  define('boot', ['require','utils','shared/settings_listener','modules/mvvm/observable','modules/mvvm/observable_array','modules/base/event_emitter','modules/settings_service','shared/screen_layout','settings'],function(require) {
